    ...
    const skillCategories = [
        {
            ...
            description: "Building complete web applications from frontend to backend with modern JavaScript technologies",
            subsections: [
                {
                ...
                },
                {
                    ...
                    skills: [
                        ...
                        { name: "MongoDB", desc: "NoSQL database management & data modeling" },
        ...
        },
        {
            ...
            description: "Strong foundation in algorithms and problem-solving with Java",
            skills: [
                { name: "Data Structures", desc: "Arrays, Linked Lists, Trees, Graphs, Heaps" },
        ...
        },
        {
            ...
            description: "Solid understanding of fundamental computer science concepts",
            skills: [
                { name: "OOP", desc: "Object-Oriented Programming, Design patterns & principles" },
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-20">
                    ...
                    <p className="text-gray-400 text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
                        A comprehensive showcase of my technical capabilities as a MERN Full Stack Developer, 
                        with a passion for continuous learning and community engagement
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                    {stats.map((stat, index) => (
                        <div
                            key={index}
                            className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 border border-gray-700 hover:border-blue-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20 text-center"
                        >
                ...
                <div className="mb-12">
                    <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-1 shadow-2xl shadow-purple-500/30">
                        <div className="bg-gray-900 rounded-3xl px-8 py-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {skillCategories.map((category, index) => (
                        <div
                            key={index}
                            className={`group bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-3xl p-8 border border-gray-700 hover:border-gray-600 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10 hover:-translate-y-2 ${
                                category.subsections ? 'lg:col-span-2' : ''
                            }`}
                        >
                            {/* Category Header */}
                            <div className="flex items-start gap-4 mb-6">
                                <div className={`bg-gradient-to-r ${category.color} p-4 rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300 text-4xl`}>
                                    {category.icon}
                                </div>
                                    ...
                                    {category.subsections.map((subsection, subIndex) => (
                                        <div key={subIndex}>
                                            <h3 className="text-lg font-bold text-blue-400 mb-4 flex items-center gap-2">
                                                <span className="text-2xl">{subIndex === 0 ? '💻' : '🗄️'}</span>
                                                {subsection.subtitle}
                                            </h3>
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-br from-blue-900/20 to-blue-800/20 backdrop-blur-sm rounded-2xl p-8 border border-blue-700/30">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            The MERN stack provides a powerful, unified JavaScript ecosystem for building modern web applications. 
                            From database to frontend, I leverage MongoDB for flexible data storage, Express and Node.js for 
                            robust server-side operations, and React for creating dynamic, responsive user interfaces.
                        </p>
                    </div>
                    <div className="bg-gradient-to-br from-purple-900/20 to-purple-800/20 backdrop-blur-sm rounded-2xl p-8 border border-purple-700/30">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            Technology evolves rapidly, and so do I. Currently exploring AI and machine learning with Python 
                            while mastering advanced MERN concepts. I believe in learning in public and contributing to open 
                            source to grow together with the community.
                        </p>
                    </div>
                </div>
